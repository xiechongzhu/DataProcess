...
namespace DataProcess.Controls
{
    ...
    public partial class YaoCeShuJuXianShi : UserControl
    {
        ...
        bool bRecvStatusData_DHK_Tou = false;
        bool bRecvStatusData_DHK_Ti = false;
...
private void InitYaoCeChartDataSource()
{
    ...
    chart_DHKuaiSu_Tou_JiaoDu_FuYangJiao.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_JiaoDu_FuYangJiaoList;
    chart_DHKuaiSu_Tou_JiaoDu_GunZhuanJiao.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_JiaoDu_GunZhuanJiaoList;
    chart_DHKuaiSu_Tou_JiaoDu_PianHangJiao.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_JiaoDu_PianHangJiaoList;
    chart_DHKuaiSu_Tou_TuoLuo_TuoLuoX.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_TuoLuo_TuoLuoXList;
    chart_DHKuaiSu_Tou_TuoLuo_TuoLuoY.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_TuoLuo_TuoLuoYList;
    chart_DHKuaiSu_Tou_TuoLuo_TuoLuoZ.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_TuoLuo_TuoLuoZList;
    chart_DHKuaiSu_Tou_JiaSuDu_JiaJiX.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_JiaSuDu_JiaJiXList;
    chart_DHKuaiSu_Tou_JiaSuDu_JiaJiY.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_JiaSuDu_JiaJiYList;
    chart_DHKuaiSu_Tou_JiaSuDu_JiaJiZ.DataSource = yaoCeChartDataSource.chart_DHKuaiSu_Tou_JiaSuDu_JiaJiZList;
    ...
    chart_DHManSu_Tou_ZuoBiao_WeiDu_ZuHe.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_ZuoBiao_WeiDuZuHeList;
    chart_DHManSu_Tou_ZuoBiao_JingDu_ZuHe.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_ZuoBiao_JingDuZuHeList;
    chart_DHManSu_Tou_ZuoBiao_GaoDu_ZuHe.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_ZuoBiao_GaoDuZuHeList;

    chart_DHManSu_Tou_SuDu_Dong_ZuHe.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_SuDu_DongZuHeList;
    chart_DHManSu_Tou_SuDu_Bei_ZuHe.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_SuDu_BeiZuHeList;
    chart_DHManSu_Tou_SuDu_Tian_ZuHe.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_SuDu_TianZuHeList;
    ...
    chart_DHManSu_Tou_SuDu_FuYangJiao.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_JiaoDu_FuYangJiaoList;
    chart_DHManSu_Tou_SuDu_GunZhuanJiao.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_JiaoDu_GunZhuanJiaoList;
    chart_DHManSu_Tou_SuDu_PianHangJiao.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_JiaoDu_PianHangJiaoList;
    chart_DHManSu_Tou_SuDu_TuoLuoX.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_TuoLuo_TuoLuoXList;
    chart_DHManSu_Tou_SuDu_TuoLuoY.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_TuoLuo_TuoLuoYList;
    chart_DHManSu_Tou_SuDu_TuoLuoZ.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_TuoLuo_TuoLuoZList;
    chart_DHManSu_Tou_SuDu_JiaJiX.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_JiaSuDu_JiaJiXList;
    chart_DHManSu_Tou_SuDu_JiaJiY.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_JiaSuDu_JiaJiYList;
    chart_DHManSu_Tou_SuDu_JiaJiZ.DataSource = yaoCeChartDataSource.chart_DHManSu_Tou_JiaSuDu_JiaJiZList;
...
private void startLoadOffLineFile(string filePath)
{
    ...
    bRecvStatusData_DHK = false;
    bRecvStatusData_DHM = false;
            bRecvStatusData_DHK_Ti = false;
            bRecvStatusData_DHK_Tou = false;
...
private void showSystemTimeStatus(ref SYSTEMPARSE_STATUS sObject)
{
    ...
    stringBuilder_ShuRuCaiJi4.Append("触点7：");
    stringBuilder_ShuRuCaiJi4.Append(CJ4_chuDian7 == 0 ? "无效" : "有效");
    stringBuilder_ShuRuCaiJi4.Append(";");
    stringBuilder_ShuRuCaiJi4.Append("触点8：");
    stringBuilder_ShuRuCaiJi4.Append(CJ4_chuDian8 == 0 ? "无效" : "有效");
    stringBuilder_ShuRuCaiJi4.Append(";");
    stringBuilder_ShuRuCaiJi4.Append("触点9：");
    stringBuilder_ShuRuCaiJi4.Append(CJ4_chuDian9 == 0 ? "无效" : "有效");
    stringBuilder_ShuRuCaiJi4.Append(";");
    stringBuilder_ShuRuCaiJi4.Append("触点10：");
    stringBuilder_ShuRuCaiJi4.Append(CJ4_chuDian10 == 0 ? "无效" : "有效");
    stringBuilder_ShuRuCaiJi4.Append(".");
    if (CJ4 == 0)
    {
        ...
        case WM_YAOCE_daoHangKuaiSu_Tou_DATA:
            {
                ...
                double gunZhuan = Convert.ToDouble(sObject.gunZhuanJiao);
                double pianHang = Convert.ToDouble(sObject.pianHangJiao);
                AddDHKTouJiaoDu(fuYang, gunZhuan, pianHang);

                //添加导航数据快速陀螺坐标集
                double x = Convert.ToDouble(sObject.tuoLuoShuJu_X);
                double y = Convert.ToDouble(sObject.tuoLuoShuJu_Y);
                double z = Convert.ToDouble(sObject.tuoLuoShuJu_Z);
                AddDHKTouTuoLuo(x, y, z);

                //添加导航数据快速加速度坐标集
                double jiaJiX = Convert.ToDouble(sObject.jiaSuDuJiShuJu_X);
                double jiaJiY = Convert.ToDouble(sObject.jiaSuDuJiShuJu_Y);
                double jiaJiZ = Convert.ToDouble(sObject.jiaSuDuJiShuJu_Z);
                AddDHKTouJiaSuDu(jiaJiX, jiaJiY, jiaJiZ);
